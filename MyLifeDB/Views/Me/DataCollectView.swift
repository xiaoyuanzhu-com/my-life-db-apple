...
let dataCategories: [DataCategory] = [
    DataCategory(
        ...
        sources: [
            ...
            DataSource(id: "body_height", name: "Height", icon: "arrow.up.and.down", description: "Body height", platform: .iOS, status: .available),
            DataSource(id: "body_fat", name: "Body Fat %", icon: "percent", description: "Body fat percentage", platform: .iOS, status: .available),
            DataSource(id: "lean_body_mass", name: "Lean Body Mass", icon: "figure.arms.open", description: "Muscle + bone mass", platform: .iOS, status: .available),
            DataSource(id: "bmi", name: "BMI", icon: "chart.bar.xaxis", description: "Body mass index", platform: .iOS, status: .available),
            DataSource(id: "waist_circumference", name: "Waist Circumference", icon: "circle.dashed", description: "Waist measurement", platform: .iOS, status: .available),
            DataSource(id: "wrist_temperature", name: "Wrist Temperature", icon: "thermometer.medium", description: "Overnight skin temperature from Apple Watch", platform: .watch, status: .available),
            DataSource(id: "basal_energy", name: "Basal Energy", icon: "flame", description: "Calories burned at rest", platform: .iOSWatch, status: .available),
            DataSource(id: "blood_pressure", name: "Blood Pressure", icon: "waveform.path.ecg.rectangle.fill", description: "Systolic & diastolic (manual entry or cuff)", platform: .iOS, status: .available),
            DataSource(id: "blood_glucose", name: "Blood Glucose", icon: "drop.fill", description: "Blood sugar level (manual entry or CGM)", platform: .iOS, status: .available),
            DataSource(id: "high_heart_rate_event", name: "High Heart Rate Events", icon: "heart.slash.fill", description: "Notifications when HR exceeds threshold", platform: .watch, status: .available),
            DataSource(id: "low_heart_rate_event", name: "Low Heart Rate Events", icon: "heart.slash", description: "Notifications when HR drops below threshold", platform: .watch, status: .available),
            DataSource(id: "irregular_rhythm_event", name: "Irregular Rhythm", icon: "waveform.path.ecg", description: "Irregular heartbeat detections", platform: .watch, status: .available),
            DataSource(id: "afib_burden", name: "AFib Burden", icon: "waveform.badge.exclamationmark", description: "% of time in atrial fibrillation", platform: .watch, status: .available),
            DataSource(id: "walking_steadiness", name: "Walking Steadiness", icon: "figure.walk.motion", description: "Fall risk assessment", platform: .watch, status: .available),
            DataSource(id: "walking_speed", name: "Walking Speed", icon: "figure.walk", description: "Average walking speed", platform: .watch, status: .available),
            DataSource(id: "walking_step_length", name: "Step Length", icon: "arrow.left.and.right", description: "Average step length while walking", platform: .watch, status: .available),
            DataSource(id: "walking_asymmetry", name: "Walking Asymmetry", icon: "figure.walk.departure", description: "Left/right step time difference", platform: .watch, status: .available),
            DataSource(id: "walking_double_support", name: "Double Support Time", icon: "figure.walk.arrival", description: "Time both feet are on the ground", platform: .watch, status: .available),
            DataSource(id: "stair_ascent_speed", name: "Stair Ascent Speed", icon: "figure.stairs", description: "Speed going up stairs", platform: .watch, status: .available),
            DataSource(id: "stair_descent_speed", name: "Stair Descent Speed", icon: "figure.stairs", description: "Speed going down stairs", platform: .watch, status: .available),
        ]
    ),
    DataCategory(
        id: "sleep",
    ...
    DataCategory(
        ...
        sources: [
            ...
            DataSource(id: "noise", name: "Ambient Noise", icon: "ear.fill", description: "Environmental noise level in dBASPL (Apple Watch)", platform: .watch, status: .available),
            DataSource(id: "headphone_audio", name: "Headphone Audio", icon: "headphones", description: "Headphone audio exposure level in dBASPL", platform: .iOSWatch, status: .available),
            DataSource(id: "uv_exposure", name: "UV Exposure", icon: "sun.max.trianglebadge.exclamationmark.fill", description: "UV radiation exposure (manual entry or compatible device)", platform: .iOS, status: .available),
